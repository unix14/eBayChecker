...
/**
 * Model class is a part of MVC structure.<br>
 *  The Model class is responsible for all the calculations of the maze.
 */
public interface Model {
	...
	public void displayCrossSection(String x,int index,String name) throws Exception;
